...
- [**Fan Out / Fan In**](patterns/fan-out-fan-in/README.md): A pattern breaks a large workload into a collection of smaller tasks with process tracking and results aggregation. This is particularly useful for batch processing.
