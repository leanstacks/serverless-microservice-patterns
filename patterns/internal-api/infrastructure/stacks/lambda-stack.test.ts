...
describe('LambdaStack', () => {
  describe('dev environment', () => {
    ...
    it('should create a list tasks Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-list-tasks-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a daily planner Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-daily-planner-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a get task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-get-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a create task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-create-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create an update task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-update-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a delete task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-delete-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create an API Gateway REST API', () => {
      template.hasResourceProperties('AWS::ApiGateway::RestApi', {
        Name: 'smp-simple-web-service-api-dev',
    ...
    it('should export API URL', () => {
      template.hasOutput('ApiUrl', {
        Export: {
          Name: 'smp-simple-web-service-tasks-api-url-dev',
        },
      });
    });
    ...
    it('should export API ID', () => {
      template.hasOutput('ApiId', {
        Export: {
          Name: 'smp-simple-web-service-tasks-api-id-dev',
        },
      });
    });
    ...
    it('should export Lambda function ARN', () => {
      template.hasOutput('ListTasksFunctionArn', {
        Export: {
          Name: 'smp-simple-web-service-list-tasks-function-arn-dev',
        },
      });
    });
    ...
    it('should export create task function ARN', () => {
      template.hasOutput('CreateTaskFunctionArn', {
        Export: {
          Name: 'smp-simple-web-service-create-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export get task function ARN', () => {
      template.hasOutput('GetTaskFunctionArn', {
        Export: {
          Name: 'smp-simple-web-service-get-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export update task function ARN', () => {
      template.hasOutput('UpdateTaskFunctionArn', {
        Export: {
          Name: 'smp-simple-web-service-update-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export delete task function ARN', () => {
      template.hasOutput('DeleteTaskFunctionArn', {
        Export: {
          Name: 'smp-simple-web-service-delete-task-function-arn-dev',
        },
      });
    });
  ...
  describe('prd environment', () => {
    ...
    it('should create Lambda with prd naming', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-simple-web-service-list-tasks-prd',
      });
    });
    ...
    it('should create API Gateway with prd naming', () => {
      template.hasResourceProperties('AWS::ApiGateway::RestApi', {
        Name: 'smp-simple-web-service-api-prd',
