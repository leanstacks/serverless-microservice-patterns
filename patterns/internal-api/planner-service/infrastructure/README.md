...
# Optional - Application name (default: smp-internal-api-planner-service)
# CDK_APP_NAME=my-app
...
npm run cdk diff smp-internal-api-planner-service-data-dev

# Deploy a specific stack
npm run cdk deploy smp-internal-api-planner-service-data-dev
