...
describe('LambdaStack', () => {
  describe('dev environment', () => {
    ...
    beforeAll(() => {
      ...
      const stack = new LambdaStack(testApp, 'TestLambdaStack', {
        appName: 'smp-internal-handoff-task-service',
        envName: 'dev',
    ...
    it('should create a list tasks Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-list-tasks-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a get task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-get-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a create task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-create-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create an update task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-update-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create a delete task Lambda function', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-delete-task-dev',
        Runtime: 'nodejs24.x',
        Handler: 'handler',
        Timeout: 10,
        MemorySize: 256,
    ...
    it('should create an API Gateway REST API', () => {
      template.hasResourceProperties('AWS::ApiGateway::RestApi', {
        Name: 'smp-internal-handoff-task-service-api-dev',
    ...
    it('should export API URL', () => {
      template.hasOutput('ApiUrl', {
        Export: {
          Name: 'smp-internal-handoff-task-service-tasks-api-url-dev',
        },
      });
    });
    ...
    it('should export API ID', () => {
      template.hasOutput('ApiId', {
        Export: {
          Name: 'smp-internal-handoff-task-service-tasks-api-id-dev',
        },
      });
    });
    ...
    it('should export Lambda function ARN', () => {
      template.hasOutput('ListTasksFunctionArn', {
        Export: {
          Name: 'smp-internal-handoff-task-service-list-tasks-function-arn-dev',
        },
      });
    });
    ...
    it('should export create task function ARN', () => {
      template.hasOutput('CreateTaskFunctionArn', {
        Export: {
          Name: 'smp-internal-handoff-task-service-create-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export get task function ARN', () => {
      template.hasOutput('GetTaskFunctionArn', {
        Export: {
          Name: 'smp-internal-handoff-task-service-get-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export update task function ARN', () => {
      template.hasOutput('UpdateTaskFunctionArn', {
        Export: {
          Name: 'smp-internal-handoff-task-service-update-task-function-arn-dev',
        },
      });
    });
    ...
    it('should export delete task function ARN', () => {
      template.hasOutput('DeleteTaskFunctionArn', {
        Export: {
          Name: 'smp-internal-handoff-task-service-delete-task-function-arn-dev',
        },
      });
    });
  ...
  describe('prd environment', () => {
    ...
    it('should create Lambda with prd naming', () => {
      template.hasResourceProperties('AWS::Lambda::Function', {
        FunctionName: 'smp-internal-handoff-task-service-list-tasks-prd',
      });
    });
    ...
    it('should create API Gateway with prd naming', () => {
      template.hasResourceProperties('AWS::ApiGateway::RestApi', {
        Name: 'smp-internal-handoff-task-service-api-prd',
