...
describe('config', () => {
  ...
  describe('getConfig', () => {
    it('should return valid configuration when CDK_ENV is set', () => {
      ...
      expect(config.CDK_APP_NAME).toBe('smp-internal-handoff-notification-service');
    });
  ...
  describe('getTags', () => {
    it('should return standard tags', () => {
      const config: Config = {
        CDK_APP_NAME: 'smp-internal-handoff-notification-service',
        CDK_ENV: 'dev',
        CDK_OU: 'leanstacks',
        CDK_OWNER: 'platform-team',
      ...
      expect(tags).toEqual({
        App: 'smp-internal-handoff-notification-service',
        Env: 'dev',
        OU: 'leanstacks',
        Owner: 'platform-team',
      });
