...
# Optional - Application name (default: smp-fan-out-fan-in-task-service)
CDK_APP_NAME=smp-fan-out-fan-in-task-service
...
npm run cdk diff smp-fan-out-fan-in-task-service-data-dev

# Deploy a specific stack
npm run cdk deploy smp-fan-out-fan-in-task-service-data-dev
