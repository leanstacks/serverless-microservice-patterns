...
export class LambdaStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: LambdaStackProps) {
    ...
    this.listTasksFunction = new NodejsFunction(this, 'ListTasksFunction', {
      ...
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/api/list-tasks.ts'),
    ...
    this.getTaskFunction = new NodejsFunction(this, 'GetTaskFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/api/get-task.ts'),
      environment: lambdaEnvironment,
      timeout: cdk.Duration.seconds(10),
      memorySize: 256,
      bundling: {
    ...
    this.createTaskFunction = new NodejsFunction(this, 'CreateTaskFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/api/create-task.ts'),
      environment: lambdaEnvironment,
      timeout: cdk.Duration.seconds(10),
      memorySize: 256,
      bundling: {
    ...
    this.updateTaskFunction = new NodejsFunction(this, 'UpdateTaskFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/api/update-task.ts'),
      environment: lambdaEnvironment,
      timeout: cdk.Duration.seconds(10),
      memorySize: 256,
      bundling: {
    ...
    this.deleteTaskFunction = new NodejsFunction(this, 'DeleteTaskFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/api/delete-task.ts'),
      environment: lambdaEnvironment,
      timeout: cdk.Duration.seconds(10),
      memorySize: 256,
      bundling: {
    ...
    this.createTaskSubscriberFunction = new NodejsFunction(this, 'CreateTaskSubscriberFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/sqs/create-task-subscriber.ts'),
      environment: lambdaEnvironment,
    ...
    this.uploadTaskSubscriberFunction = new NodejsFunction(this, 'UploadTaskSubscriberFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/sqs/upload-task-subscriber.ts'),
      environment: lambdaEnvironment,
    ...
    this.completeTaskFileSubscriberFunction = new NodejsFunction(this, 'CompleteTaskFileSubscriberFunction', {
      ...
      runtime: lambda.Runtime.NODEJS_24_X,
      handler: 'handler',
      entry: path.join(__dirname, '../../src/handlers/sqs/complete-task-file-subscriber.ts'),
      environment: lambdaEnvironment,
      timeout: cdk.Duration.seconds(30),
      memorySize: 256,
      bundling: {
