...
export const getTask = async (id: string): Promise<Task | null> => {
  logger.info({ taskId: id }, '[TaskService] > getTask');
  ...
  try {
    ...
    logger.info({ taskId: id }, '[TaskService] < getTask - successfully retrieved task');
...
export const updateTask = async (id: string, updateTaskDto: UpdateTaskDto): Promise<Task | null> => {
  logger.info({ taskId: id }, '[TaskService] > updateTask');
  ...
  try {
    ...
    logger.info({ taskId: task.id }, '[TaskService] < updateTask - successfully updated task');
...
export const deleteTask = async (id: string): Promise<boolean> => {
  logger.info({ taskId: id }, '[TaskService] > deleteTask');
