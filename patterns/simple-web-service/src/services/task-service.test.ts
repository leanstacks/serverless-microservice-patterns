...
describe('task-service', () => {
  ...
  describe('updateTask', () => {
    ...
    it('should update a task with all fields', async () => {
      ...
      expect(result?.updatedAt).toBe('2025-12-01T10:00:00.000Z');
      expect(mockSend).toHaveBeenCalledTimes(1);
      expect(mockLoggerInfo).toHaveBeenCalledWith({ taskId: taskId }, '[TaskService] > updateTask');
    });
    ...
    it('should return null when task is not found', async () => {
      ...
      expect(result).toBeNull();
      expect(mockSend).toHaveBeenCalledTimes(1);
      expect(mockLoggerInfo).toHaveBeenCalledWith({ taskId: taskId }, '[TaskService] < updateTask - task not found');
    });
  ...
  describe('deleteTask', () => {
    it('should delete a task successfully', async () => {
      ...
      expect(mockLoggerInfo).toHaveBeenCalledWith({ taskId: taskId }, '[TaskService] > deleteTask');
      expect(mockLoggerInfo).toHaveBeenCalledWith(
        { taskId: taskId },
    ...
    it('should return false when task does not exist', async () => {
      ...
      expect(mockSend).toHaveBeenCalledTimes(1);
      expect(mockLoggerInfo).toHaveBeenCalledWith({ taskId: taskId }, '[TaskService] < deleteTask - task not found');
    });
