...
# Optional - Application name (default: smp-queue-leveling-task-service)
# CDK_APP_NAME=my-app
...
npm run cdk diff smp-queue-leveling-task-service-data-dev

# Deploy a specific stack
npm run cdk deploy smp-queue-leveling-task-service-data-dev
